            ...
            <Box component="section" className={classes.newAppointmentContainer}>
                ...
                <Box component="section" className={classes.newAppointmentForm} >
                    <Box component="section" className={classes.newAppointmentFormHead} >
                        ...
                        <Button size='small' variant="contained" sx={{ textTransform: "none", fontSize: "1em" }}>My Appointments</Button>
                    </Box>


                    <Box component="section" className={classes.newAppointmentDocDetails} >
                        <Typography sx={{ fontWeight: "bold", fontSize: "1.2em", marginBottom: "0.4em" }}>Selected Doctor Details</Typography>
                        <Box component="article" className={classes.formRows}>
                            <TextField size='small' className={classes.inputs} label="Name" variant="outlined"
                                value={selectedDoctor ? `${selectedDoctor.firstName} ${selectedDoctor.lastName}` : ""} disabled />
                            <TextField size='small' type='text' className={classes.inputs} label="Phone" variant="outlined"
                                value={selectedDoctor ? selectedDoctor.phone : ""} disabled />
                        </Box>

                        <Box component="article" className={classes.formRows}>
                            <TextField size='small' type='text' className={classes.inputs} label="Specialization" variant="outlined"
                                value={selectedDoctor ? selectedDoctor.specialization : ""} disabled />
                            <TextField size='small' className={classes.inputs} label="Consultation Fee" variant="outlined"
                                required inputProps={{ min: 0 }}
                                value={selectedDoctor ? selectedDoctor.consultationFee : ""} disabled />
                        </Box>

                        <Box component="article" className={classes.formRows}>
                            <TextField size='small' type='text' className={classes.inputs} label="Address" variant="outlined"
                    ...
                    <Box component="section" className={classes.newAppointmentBooking} >
                        <Typography sx={{ fontWeight: "bold", fontSize: "1.2em", margin: "2em 0 0.4em 0" }}>Book Your Appointment</Typography>
                        ...
                        <Box component="article" className={classes.formRows}>
                            <TextField size='small' className={classes.inputs} label="Date" variant="outlined"
                                onChange={(e) => setBookAppointment({ ...bookAppointment, date: e.target.date })}
                                value={bookAppointment.date} required />
                            <TextField size='small' type='text' className={classes.inputs} label="Time" variant="outlined"
                        ...
                        <Box component="section" className={classes.buttonSection} >
                            <Button size='small' variant="outlined" sx={{ textTransform: "none", fontSize: "1em" }} className={classes.button} onClick={handleCheckAvailability}>Check Availability</Button>
                            <Button size='small' variant="contained" sx={{ textTransform: "none", fontSize: "1em" }} className={classes.button} onClick={handleBookNow} >Book Now</Button>
                        </Box>
